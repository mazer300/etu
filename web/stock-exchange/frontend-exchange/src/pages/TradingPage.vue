      ...
      <div class="stocks-section">
        ...
        <div class="stocks-grid">
          ...
          >
            ...
            <!-- НОВАЯ СЕКЦИЯ: Кнопка просмотра графика -->
            <div class="chart-action-section">
              <button
                  @click="openChart(stock)"
                  class="action-btn chart-view"
                  title="Посмотреть график цен"
              >
                📈 Просмотр графика
              </button>
            </div>
...
/* НОВЫЙ СТИЛЬ: Секция кнопки просмотра графика */
.chart-action-section {
  margin-bottom: 1rem;
  text-align: center;
}

.action-btn.chart-view {
  width: 100%;
  padding: 0.75rem;
  background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
  color: white;
